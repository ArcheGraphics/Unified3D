...
public:
    ...
    OrientedBoundingBox(Eigen::Vector3d center,
                        Eigen::Matrix3d R,
...
public:
    ...
    OrientedBoundingBox& Translate(const Eigen::Vector3d& translation,
                                   bool relative = true) override;
    OrientedBoundingBox& Scale(double scale,
                               const Eigen::Vector3d& center) override;
    OrientedBoundingBox& Rotate(const Eigen::Matrix3d& R,
                                const Eigen::Vector3d& center) override;
...
public:
    ...
    AxisAlignedBoundingBox& Transform(
            const Eigen::Matrix4d& transformation) override;
    AxisAlignedBoundingBox& Translate(const Eigen::Vector3d& translation,
                                      bool relative = true) override;
    ...
    AxisAlignedBoundingBox& Scale(double scale,
                                  const Eigen::Vector3d& center) override;

    /// \brief an AxisAlignedBoundingBox can not be rotated. This method
    /// will throw an error.
    AxisAlignedBoundingBox& Rotate(const Eigen::Matrix3d& R,
                                   const Eigen::Vector3d& center) override;

    AxisAlignedBoundingBox& operator+=(const AxisAlignedBoundingBox& other);

    /// Get the extent/length of the bounding box in x, y, and z dimension.
    [[nodiscard]] Eigen::Vector3d GetExtent() const {
        return (max_bound_ - min_bound_);
    }

    /// Returns the half extent of the bounding box.
    [[nodiscard]] Eigen::Vector3d GetHalfExtent() const {
        return GetExtent() * 0.5;
    }

    /// Returns the maximum extent, i.e. the maximum of X, Y and Z axis'
    /// extents.
    [[nodiscard]] double GetMaxExtent() const {
