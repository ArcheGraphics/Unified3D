...
#include "unified3d/geometry/HalfEdgeTriangleMesh.h"
...
HalfEdgeTriangleMesh::HalfEdge::HalfEdge(Eigen::Vector2i vertex_indices,
                                         int triangle_index,
                                         int next,
                                         int twin)
    : next_(next),
...
std::vector<int> HalfEdgeTriangleMesh::BoundaryVerticesFromVertex(
    ...
    boundary_vertices.reserve(boundary_half_edges.size());
