...
#include "unified3d/geometry/Geometry2D.h"
...
public:
    ...
    [[nodiscard]] bool TestImageBoundary(double u,
                                         double v,
...
public:
    ...
    [[nodiscard]] std::pair<bool, double> FloatValueAt(double u,
                                                       double v) const;
    ...
    [[nodiscard]] std::shared_ptr<Image> ConvertDepthToFloatImage(
    ...
    [[nodiscard]] std::shared_ptr<Image> Filter(
            const std::vector<double> &dx, const std::vector<double> &dy) const;

    [[nodiscard]] std::shared_ptr<Image> FilterHorizontal(
    ...
    [[nodiscard]] ImagePyramid CreatePyramid(
