...
struct PlanarPatch {
    [[nodiscard]] double GetSignedDistanceToPoint(
...
private:
    ...
    [[nodiscard]] Eigen::Vector3d CalculateChildCenter(
            size_t child_index, double child_size) const {
        Eigen::Vector3d center;
    ...
    [[nodiscard]] size_t CalculateChildIndex(
...
public:
    ...
    [[nodiscard]] bool IsInlier(size_t idx) const {
...
private:
    ...
    [[nodiscard]] inline bool IsNormalValid() const {
    ...
    void ConstructOrthogonalBasis(Eigen::Matrix3d& B) const {
