...
public:
    ...
    [[nodiscard]] LineType GetLineType() const { return line_type_; }

    /// \brief Gets the line's origin point
    [[nodiscard]] const Eigen::Vector3d& Origin() const { return m_origin; }

    /// \brief Gets the line's direction vector
    [[nodiscard]] const Eigen::Vector3d& Direction() const {
        return m_direction;
    }
    ...
    [[nodiscard]] const Eigen::ParametrizedLine<double, 3>& Line() const {
        return *this;
    }
    ...
    [[nodiscard]] virtual std::optional<double> IntersectionParameter(
    ...
    [[nodiscard]] double ProjectionParameter(
    ...
    [[nodiscard]] virtual Eigen::Vector3d Projection(
            const Eigen::Vector3d& point) const;
    ...
    /// method
    [[nodiscard]] virtual std::optional<double> SlabAABB(
    ...
    [[nodiscard]] virtual std::optional<double> ExactAABB(
            const AxisAlignedBoundingBox& box) const;
    ...
    [[nodiscard]] std::pair<double, double> ClosestParameters(
    ...
    [[nodiscard]] std::pair<Eigen::Vector3d, Eigen::Vector3d> ClosestPoints(
            const Line3D& other) const;
    ...
    /// type.
    [[nodiscard]] double DistanceTo(const Line3D& other) const;
    ...
    /// the value of Length()
    [[nodiscard]] virtual double ClampParameter(double parameter) const {
        return parameter;
    }
    ...
    [[nodiscard]] virtual bool IsParameterValid(double parameter) const {
        return true;
    }
...
protected:
    ...
    [[nodiscard]] std::pair<double, double> SlabAABBBase(
            const AxisAlignedBoundingBox& box) const;
...
public:
    ...
    /// positive.
    [[nodiscard]] std::optional<double> IntersectionParameter(
    ...
    /// double floating point precision will not intersect correctly by this
    /// method
    [[nodiscard]] std::optional<double> SlabAABB(
    ...
    /// will be made 0 and a positive value greater than Length() will take
    /// the value of Length()
    [[nodiscard]] double ClampParameter(double parameter) const override {
    ...
    /// positive parameter is valid, and for segments any parameter between 0
    /// and the segment length is valid.
    [[nodiscard]] bool IsParameterValid(double parameter) const override {
        return parameter >= 0;
    }
};
...
public:
    ...
    [[nodiscard]] Eigen::Vector3d MidPoint() const {
        return 0.5 * (origin() + end_point_);
    }

    /// \brief Get the end point of the segment
    [[nodiscard]] const Eigen::Vector3d& EndPoint() const { return end_point_; }
    ...
    /// of the line segment.
    [[nodiscard]] AxisAlignedBoundingBox GetBoundingBox() const;
    ...
    [[nodiscard]] std::optional<double> ExactAABB(
            const AxisAlignedBoundingBox& box) const override;
