...
void Geometry3D::RotateCovariances(const Eigen::Matrix3d& R,
                                   std::vector<Eigen::Matrix3d>& covariances) {
...
Eigen::Matrix3d Geometry3D::GetRotationMatrixFromXYZ(
    ...
    return u3d::utility::RotationMatrixX(rotation(0)) *
           u3d::utility::RotationMatrixY(rotation(1)) *
           u3d::utility::RotationMatrixZ(rotation(2));
}

Eigen::Matrix3d Geometry3D::GetRotationMatrixFromYZX(
        const Eigen::Vector3d& rotation) {
    return u3d::utility::RotationMatrixY(rotation(0)) *
           u3d::utility::RotationMatrixZ(rotation(1)) *
           u3d::utility::RotationMatrixX(rotation(2));
}

Eigen::Matrix3d Geometry3D::GetRotationMatrixFromZXY(
        const Eigen::Vector3d& rotation) {
    return u3d::utility::RotationMatrixZ(rotation(0)) *
           u3d::utility::RotationMatrixX(rotation(1)) *
           u3d::utility::RotationMatrixY(rotation(2));
}
