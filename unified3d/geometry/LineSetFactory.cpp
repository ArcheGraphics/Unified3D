...
#include "unified3d/geometry/LineSet.h"
...
std::shared_ptr<LineSet> LineSet::CreateFromTriangleMesh(
    ...
    auto InsertEdge = [&](int vidx0, int vidx1) {
        ...
        if (inserted_edges.count(edge) == 0) {
            ...
            line_set->lines_.emplace_back(vidx0, vidx1);
        }
    };
...
std::shared_ptr<LineSet> LineSet::CreateFromOrientedBoundingBox(
    ...
    line_set->lines_.emplace_back(0, 1);
    line_set->lines_.emplace_back(1, 7);
    line_set->lines_.emplace_back(7, 2);
    line_set->lines_.emplace_back(2, 0);
    line_set->lines_.emplace_back(3, 6);
    line_set->lines_.emplace_back(6, 4);
    line_set->lines_.emplace_back(4, 5);
    line_set->lines_.emplace_back(5, 3);
    line_set->lines_.emplace_back(0, 3);
    line_set->lines_.emplace_back(1, 6);
    line_set->lines_.emplace_back(7, 4);
    line_set->lines_.emplace_back(2, 5);
...
std::shared_ptr<LineSet> LineSet::CreateCameraVisualization(
    ...
    auto w = double(view_width_px);
    auto h = double(view_height_px);
    ...
    lines->lines_.emplace_back(0, 1);
    lines->lines_.emplace_back(0, 2);
    lines->lines_.emplace_back(0, 3);
    lines->lines_.emplace_back(0, 4);
    lines->lines_.emplace_back(1, 2);
    lines->lines_.emplace_back(2, 3);
    lines->lines_.emplace_back(3, 4);
    lines->lines_.emplace_back(4, 1);
