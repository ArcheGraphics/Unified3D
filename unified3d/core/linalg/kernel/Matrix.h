...
namespace u3d::core::linalg::kernel {

// ---- Matmul ----
template <typename scalar_t>
static inline void matmul3x3_3x1(const scalar_t& m00,
                                 const scalar_t& m01,
                                 const scalar_t& m02,
                                 const scalar_t& m10,
                                 const scalar_t& m11,
...
template <typename scalar_t>
inline void matmul3x3_3x1(const scalar_t* A_3x3,
...
template <typename scalar_t>
inline void matmul3x3_3x3(const scalar_t* A_3x3,
...
template <typename scalar_t>
inline void cross_3x1(const scalar_t* A_3x1_input,
...
template <typename scalar_t>
inline scalar_t cross_mag_3x1(const scalar_t* A_3x1_input,
                              const scalar_t* B_3x1_input) {
    scalar_t temp_0 =
            A_3x1_input[1] * B_3x1_input[2] - A_3x1_input[2] * B_3x1_input[1];
    scalar_t temp_1 =
...
template <typename scalar_t>
inline scalar_t dot_3x1(const scalar_t* A_3x1_input,
                        const scalar_t* B_3x1_input) {
...
// ---- Determinant ----
template <typename scalar_t>
inline scalar_t det2x2(const scalar_t* A_2x2) {
    return A_2x2[0] * A_2x2[3] - A_2x2[1] * A_2x2[2];
}

template <typename scalar_t>
inline scalar_t det3x3(const scalar_t* A_3x3) {
...
template <typename scalar_t>
inline bool inverse2x2(const scalar_t* A_2x2, scalar_t* output_2x2) {
...
// ---- Matrix Inverse ----
template <typename scalar_t>
inline bool inverse3x3(const scalar_t* A_3x3, scalar_t* output_3x3) {
...
// ---- Matrix Transpose ----
template <typename scalar_t>
inline void transpose2x2_(scalar_t* A_2x2) {
...
template <typename scalar_t>
inline void transpose2x2(const scalar_t* A_2x2, scalar_t* output_2x2) {
...
template <typename scalar_t>
inline void transpose3x3_(scalar_t* A_3x3) {
...
template <typename scalar_t>
inline void transpose3x3(const scalar_t* A_3x3, scalar_t* output_3x3) {
...
template <typename scalar_t>
inline void transpose4x4_(scalar_t* A_4x4) {
...
template <typename scalar_t>
inline void transpose4x4(const scalar_t* A_4x4, scalar_t* output_4x4) {
