...
#include "unified3d/t/geometry/kernel/GeometryMacros.h"
...
template <typename scalar_t>
inline void svd3x3(const scalar_t *A_3x3,
                   scalar_t *U_3x3,
                   scalar_t *S_3x1,
                   scalar_t *V_3x3);

template <>
inline void svd3x3<double>(const double *A_3x3,
                           double *U_3x3,
                           double *S_3x1,
                           double *V_3x3) {
...
template <>
inline void svd3x3<float>(const float *A_3x3,
                          float *U_3x3,
                          float *S_3x1,
                          float *V_3x3) {
...
template <typename scalar_t>
inline void solve_svd3x3(const scalar_t *A_3x3,  // input A {3,3}
