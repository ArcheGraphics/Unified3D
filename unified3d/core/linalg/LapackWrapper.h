...
inline UNIFIED3D_CPU_LINALG_INT getrf_cpu(int layout,
                                          UNIFIED3D_CPU_LINALG_INT m,
                                          UNIFIED3D_CPU_LINALG_INT n,
                                          scalar_t* A_data,
                                          UNIFIED3D_CPU_LINALG_INT lda,
                                          UNIFIED3D_CPU_LINALG_INT* ipiv_data) {
    utility::LogError("Unsupported data type.");
    return -1;
}

template <typename scalar_t>
inline UNIFIED3D_CPU_LINALG_INT getri_cpu(int layout,
                                          UNIFIED3D_CPU_LINALG_INT n,
                                          scalar_t* A_data,
                                          UNIFIED3D_CPU_LINALG_INT lda,
                                          UNIFIED3D_CPU_LINALG_INT* ipiv_data) {
...
template <typename scalar_t>
inline UNIFIED3D_CPU_LINALG_INT gesv_cpu(int layout,
                                         UNIFIED3D_CPU_LINALG_INT n,
                                         UNIFIED3D_CPU_LINALG_INT m,
                                         scalar_t* A_data,
                                         UNIFIED3D_CPU_LINALG_INT lda,
...
template <typename scalar_t>
inline UNIFIED3D_CPU_LINALG_INT gels_cpu(int matrix_layout,
                                         char trans,
                                         UNIFIED3D_CPU_LINALG_INT m,
                                         UNIFIED3D_CPU_LINALG_INT n,
                                         UNIFIED3D_CPU_LINALG_INT nrhs,
                                         scalar_t* A_data,
                                         UNIFIED3D_CPU_LINALG_INT lda,
                                         scalar_t* B_data,
                                         UNIFIED3D_CPU_LINALG_INT ldb) {
...
template <typename scalar_t>
inline UNIFIED3D_CPU_LINALG_INT gesvd_cpu(int matrix_layout,
                                          char jobu,
                                          char jobvt,
                                          UNIFIED3D_CPU_LINALG_INT m,
                                          UNIFIED3D_CPU_LINALG_INT n,
                                          ...
                                          scalar_t* S_data,
                                          scalar_t* U_data,
                                          UNIFIED3D_CPU_LINALG_INT ldu,
                                          scalar_t* VT_data,
                                          UNIFIED3D_CPU_LINALG_INT ldvt,
                                          scalar_t* superb) {
    utility::LogError("Unsupported data type.");
    return -1;
}
...
template <>
inline UNIFIED3D_CPU_LINALG_INT getrf_cpu<float>(
        int layout,
        UNIFIED3D_CPU_LINALG_INT m,
        UNIFIED3D_CPU_LINALG_INT n,
        float* A_data,
...
template <>
inline UNIFIED3D_CPU_LINALG_INT getrf_cpu<double>(
        int layout,
        UNIFIED3D_CPU_LINALG_INT m,
        UNIFIED3D_CPU_LINALG_INT n,
        double* A_data,
...
template <>
inline UNIFIED3D_CPU_LINALG_INT getri_cpu<float>(
        int layout,
        UNIFIED3D_CPU_LINALG_INT n,
        float* A_data,
        UNIFIED3D_CPU_LINALG_INT lda,
...
template <>
inline UNIFIED3D_CPU_LINALG_INT getri_cpu<double>(
        int layout,
        UNIFIED3D_CPU_LINALG_INT n,
        double* A_data,
        UNIFIED3D_CPU_LINALG_INT lda,
...
template <>
inline UNIFIED3D_CPU_LINALG_INT gesv_cpu<float>(
        int layout,
        UNIFIED3D_CPU_LINALG_INT n,
        UNIFIED3D_CPU_LINALG_INT m,
        float* A_data,
...
template <>
inline UNIFIED3D_CPU_LINALG_INT gesv_cpu<double>(
        int layout,
        UNIFIED3D_CPU_LINALG_INT n,
        UNIFIED3D_CPU_LINALG_INT m,
        double* A_data,
...
template <>
inline UNIFIED3D_CPU_LINALG_INT gels_cpu<float>(int layout,
                                                char trans,
                                                UNIFIED3D_CPU_LINALG_INT m,
                                                UNIFIED3D_CPU_LINALG_INT n,
                                                UNIFIED3D_CPU_LINALG_INT nrhs,
...
template <>
inline UNIFIED3D_CPU_LINALG_INT gels_cpu<double>(int layout,
                                                 char trans,
                                                 UNIFIED3D_CPU_LINALG_INT m,
                                                 UNIFIED3D_CPU_LINALG_INT n,
                                                 UNIFIED3D_CPU_LINALG_INT nrhs,
...
template <>
inline UNIFIED3D_CPU_LINALG_INT gesvd_cpu<float>(int layout,
                                                 char jobu,
                                                 char jobvt,
                                                 UNIFIED3D_CPU_LINALG_INT m,
                                                 UNIFIED3D_CPU_LINALG_INT n,
...
template <>
inline UNIFIED3D_CPU_LINALG_INT gesvd_cpu<double>(int layout,
                                                  char jobu,
                                                  char jobvt,
                                                  UNIFIED3D_CPU_LINALG_INT m,
                                                  UNIFIED3D_CPU_LINALG_INT n,
