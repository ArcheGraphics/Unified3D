...
public:
    ...
    LLVM_NODISCARD [[nodiscard]] bool empty() const { return !Size; }
...
class SmallVectorTemplateCommon
    ...
    [[nodiscard]] void *getFirstEl() const {
...
protected:
    ...
    [[nodiscard]] bool isSmall() const { return this->BeginX == getFirstEl(); }
...
template <typename T>
inline void swap(u3d::core::SmallVectorImpl<T> &LHS,
                 u3d::core::SmallVectorImpl<T> &RHS) {
    LHS.swap(RHS);
}

/// Implement std::swap in terms of SmallVector swap.
template <typename T, unsigned N>
inline void swap(u3d::core::SmallVector<T, N> &LHS,
                 u3d::core::SmallVector<T, N> &RHS) {
    LHS.swap(RHS);
}
