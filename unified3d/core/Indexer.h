...
struct OffsetCalculator {
    ...
    utility::MiniVec<index_t, NARGS> get(index_t linear_idx) const {
...
public:
    ...
    /// shape.
    [[nodiscard]] const int64_t* GetPrimaryShape() const {
    ...
    [[nodiscard]] const int64_t* GetPrimaryStrides() const {
