...
#define LogError(...)                                                \
    Logger::LogError_(__FILE__, __LINE__,                            \
                      static_cast<const char *>(UNIFIED3D_FUNCTION), \
                      __VA_ARGS__)
...
public:
    ...
    /// Unified3D's python binding, the default print function is replaced with
    /// py::print().
    ///
    ...
    /// Set global verbosity level of Unified3D.
    ///
    ...
    /// Get global verbosity level of Unified3D.
    [[nodiscard]] VerbosityLevel GetVerbosityLevel() const;
